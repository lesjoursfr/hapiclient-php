...
final class RegisteredRel
{
     ...
     * Notes:.
     */
    public const CREATEFORM = 'create-form';
     ...
     * Reference: [RFC6892]
     * Notes: This link relation type is the inverse of the 'describedby' relation type.
     ...
     * If B is 'describedby' A, then A 'describes' B.
     */
     ...
     * Notes:.
     */
    public const EDITFORM = 'edit-form';
     ...
     * Notes:.
     */
    public const EDITMEDIA = 'edit-media';
     ...
     * Notes:.
     */
    public const LATESTVERSION = 'latest-version';
     ...
     * See [RFC6415] for information about processing this relation type in host-meta documents.
     * When used elsewhere, it refers to additional links and other metadata. Multiple instances indicate additional LRDD resources.
     ...
     * Notes:.
     */
    public const MONITORGROUP = 'monitor-group';
     ...
     * Notes:.
     */
    public const NEXTARCHIVE = 'next-archive';
     ...
     * Examples may include a web page where donations are accepted or where goods and services are available for purchase. rel=""payment"" is not intended to initiate an automated transaction.
     ...
     * For example, a rel=""payment"" link at the feed/channel level may point to a ""tip jar"" URI,
     * whereas an entry/ item containing a book review may include a rel=""payment"" link that points to the location where the book may be purchased through an online retailer.
     */
     ...
     * Notes:.
     */
    public const PREDECESSORVERSION = 'predecessor-version';
     ...
     * Notes:.
     */
    public const PREVARCHIVE = 'prev-archive';
     ...
     * Notes:.
     */
    public const PRIVACYPOLICY = 'privacy-policy';
     ...
     * Notes:.
     */
    public const SUCCESSORVERSION = 'successor-version';
     ...
     * Notes:.
     */
    public const TERMSOFSERVICE = 'terms-of-service';
     ...
     * Notes:.
     */
    public const VERSIONHISTORY = 'version-history';
     ...
     * Notes:.
     */
    public const WORKINGCOPY = 'working-copy';
     ...
     * Notes:.
     */
    public const WORKINGCOPYOF = 'working-copy-of';
}
